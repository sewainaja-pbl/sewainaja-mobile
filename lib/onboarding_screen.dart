...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingItem> _onboardingItems = [
    OnboardingItem(
      ...
      title: 'Potensi Tak Terbatas dengan Biaya Lebih Rendah.',
      subtitle:
    ...
    OnboardingItem(
      ...
      title: 'MAKSIMALKAN KREATIVITAS, MINIMALKAN PENGELUARAN.',
      subtitle:
          'Selesaikan proyek impianmu tanpa harus membeli alat baru. Temukan perkakas berkualitas tinggi langsung dari komunitas di sekitarmu.',
      buttonText: 'Next',
      titleFontSize: 32,
    ...
    OnboardingItem(
      ...
      title: 'Tingkatkan Gaya, Bebaskan Lemari.',
      subtitle:
          'Tampil memukau di setiap momen tanpa menumpuk pakaian. Sewa outfit eksklusif hanya untuk acara spesialmu, kapan pun kamu butuh.',
                    ...
                    child: Align(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize:
                              _onboardingItems[_currentPage].titleFontSize,
                          fontWeight:
                              _onboardingItems[_currentPage].titleFontWeight,
